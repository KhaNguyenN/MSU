...
public class KNguyenHW4 {
    ...
    private static final String INPUT_FILE = "src\\input\\hw4input1.txt";
    private static final String OUTPUT_FILE = "src\\output\\hw4output1.txt";
