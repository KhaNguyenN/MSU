...
% This example shows how to pass data from one app to another. This multiwindow app consists of a main app 
% that calls a dialog box app with input arguments. The dialog box displays a set of options for 
% modifying aspects of the main app. When the user closes it, the 
% dialog box sends their selections back to the main app.   
%
