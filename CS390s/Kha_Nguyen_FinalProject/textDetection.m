...
path='./Image_Folder/Output/'; % this is your working path
impath=[ path,'Aseg1.png' ]; % path of the image
colorImage=imread(impath);
figure,imshow(colorImage); % you could also try image() imagesc() other image display functions 

I=rgb2gray(colorImage); % change image to gray scale
