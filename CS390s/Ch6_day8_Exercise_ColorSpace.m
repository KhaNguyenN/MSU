 ...
 im1= imread('./standard_test_images/standard_test_images/R.jpg');
 X1=(im1(:,:,1)+im1(:,:,2)+im1(:,:,3))/3;
 im2 = imread('./standard_test_images/standard_test_images/G.jpg');
 X2 =(im2(:,:,1)+im2(:,:,2)+im2(:,:,3))/3;
 im3 = imread('./standard_test_images/standard_test_images/B.jpg');
