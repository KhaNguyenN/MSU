...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
datapath = uigetdir('C:\Users\khang\Documents\MATLAB\face_recognition','select path of training images');
testpath = uigetdir('C:\Users\khang\Documents\MATLAB\face_recognition','select path of test images');
...
TestImage = strcat(testpath,'\',char(TestImage),'.bmp');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
